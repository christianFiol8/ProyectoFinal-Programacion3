...
public class AuthView_GroupView {

	public AuthController_Home home;
	public AuthController_Group group;
	private JFrame frame;
	
	public AuthView_GroupView() {
...
metodoMenu(panel);
	...
	public void confirmarCrearPanel() {
		...
		JLabel lblNewLabel_24 = new JLabel("¿Esta seguro de que quiere crear a este grupo?");
...
metodoMenu(panel);
	...
	public void listaAlumnosPanel3() {
		...
		JButton btnNewButton_14 = new JButton("Eliminar Lista");
		btnNewButton_14.setFont(new Font("Inter", Font.BOLD, 16));
		btnNewButton_14.setBounds(256, 381, 300, 30);
		btnNewButton_14.addActionListener(new ActionListener() {
